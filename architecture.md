...
This deployment strategy minimizes infrastructure complexity. Given that for production grade deployment we will dockerize/containerize the application with light weight Node Image and deploy in VM or K8.
